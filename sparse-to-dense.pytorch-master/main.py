...
parser.add_argument('--outputdir', '-n', metavar='OUTDIR', default='')
...
def main():
    ...
    output_directory = os.path.join('/media/kuowei/8EB89C8DB89C7585/results_CS','{}'.format(args.outputdir),
    ...
    traindir = os.path.join('/media/kuowei/8EB89C8DB89C7585/data', args.data, 'train')
    valdir = os.path.join('/media/kuowei/8EB89C8DB89C7585/data', args.data, 'val')
    ...
    # create new model
        ...
        if args.arch == 'resnet50':
            ...
            model = ResNet(layers=152, decoder=args.decoder, in_channels=in_channels,
                out_channels=out_channels, pretrained=args.pretrained)
        print("=> model created.")
